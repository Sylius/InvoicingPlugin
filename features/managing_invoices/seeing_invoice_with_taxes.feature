...
Feature: Seeing taxes on an invoice
    ...
    Scenario: Seeing proper taxes on an invoice
        ...
        Then it should have 2 "PHP T-Shirt" shipment with unit price "60.00", net value "120.00", tax total "27.60" and total "147.60" in "USD" currency
        And it should have 3 "Symfony Mug" shipment with unit price "40.00", net value "120.00", tax total "12.00" and total "132.00" in "USD" currency
        And its subtotal should be "250.00"
        And it should have a tax item "US VAT (23%)" with amount "27.60" in "USD" currency
        And it should have a tax item "Low VAT (10%)" with amount "12.00" in "USD" currency
