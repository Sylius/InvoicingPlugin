...
Feature: Seeing an invoice with items having promotion applied
    ...
    Scenario: Seeing proper amounts of line items having promotions applied on an invoice
        ...
        Then it should have 2 "Angel T-Shirt" items with unit price "9.00", net value "18.00", tax total "0.00" and total "18.00" in "USD" currency
        And it should have 1 "Galaxy Post" shipment with unit price "10.00", net value "10.00", tax total "0.00" and total "10.00" in "USD" currency
